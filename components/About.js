  ...
  return (
    <section id="about" className="min-h-screen bg-black flex items-center justify-center p-8">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="bg-gray-900/50 p-12 rounded-lg font-mono text-xs sm:text-sm md:text-base lg:text-lg h-[300px] flex items-start">
          <TypeWriter
...
And hey, if you need a more formal explanation, check out the rest of this site. 'Cause yeah, I can be diligent too.`}
        ...
        <div className="text-center mt-60">
          <Link
            href="/about"
            className="inline-flex items-center text-lg border-2 border-white px-8 py-3 rounded-full hover:bg-white hover:text-black transition-all duration-300 shine-button"
          >
