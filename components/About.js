  ...
  return (
    <section id="about" className="min-h-screen bg-black flex items-center justify-center p-8">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="bg-gray-900/50 rounded-lg font-mono text-sm md:text-base lg:text-lg p-6 md:p-12 h-[360px] md:h-auto overflow-hidden md:overflow-visible">
          <TypeWriter
...
And hey, if you need a more formal explanation, check out the rest of this site. 'Cause yeah, I can be diligent too.`}
        ...
        <div className="text-center mt-10 md:mt-16 translate-y-10 md:translate-y-8">
            <Link
              href="/about"
              className="
